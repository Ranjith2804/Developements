...
const mapTopics = [
    {
        num: 1, icon: '🏗️', title: 'System Design', level: 'Foundation',
    ...
    {
        num: 2, icon: '💻', title: 'Operating Systems', level: 'Foundation',
    ...
    {
        num: 3, icon: '🌐', title: 'Computer Networks', level: 'Foundation',
    ...
    {
        num: 4, icon: '⚙️', title: 'Backend Development', level: 'Foundation',
    ...
    {
        num: 5, icon: '🗄️', title: 'DBMS', level: 'Foundation',
    ...
    {
        num: 6, icon: '🔒', title: 'Security', level: 'Core',
    ...
    {
        num: 7, icon: '📡', title: 'HTTP Protocol', level: 'Core',
    ...
    {
        num: 8, icon: '🔀', title: 'Routing', level: 'Core',
    ...
    {
        num: 9, icon: '📦', title: 'Serialization', level: 'Core',
    ...
    {
        num: 10, icon: '🛡️', title: 'Authentication & Authorization', level: 'Core',
    ...
    {
        num: 11, icon: '✅', title: 'Validation & Transformation', level: 'Core',
    ...
    {
        num: 12, icon: '🔧', title: 'Middleware', level: 'Core',
    ...
    {
        num: 13, icon: '📋', title: 'Request Context', level: 'Core',
    ...
    {
        num: 14, icon: '🎯', title: 'Handlers / Controllers', level: 'Core',
    ...
    {
        num: 15, icon: '📝', title: 'CRUD Deep Dive', level: 'Core',
    ...
    {
        num: 16, icon: '📐', title: 'REST Best Practices', level: 'Core',
    ...
    {
        num: 17, icon: '🗃️', title: 'Databases — Practical', level: 'Core',
    ...
    {
        num: 18, icon: '🧠', title: 'Business Logic Layer', level: 'Core',
    ...
    {
        num: 19, icon: '⚡', title: 'Caching', level: 'Advanced',
    ...
    {
        num: 20, icon: '📧', title: 'Transactional Emails', level: 'Core',
    ...
    {
        num: 21, icon: '⏳', title: 'Task Queuing & Scheduling', level: 'Advanced',
    ...
    {
        num: 22, icon: '🔍', title: 'Elasticsearch', level: 'Advanced',
    ...
    {
        num: 23, icon: '⚙️', title: 'Configuration Management', level: 'Core',
    ...
    {
        num: 24, icon: '📊', title: 'Logging & Observability', level: 'Advanced',
    ...
    {
        num: 25, icon: '🛑', title: 'Graceful Shutdown', level: 'Advanced',
    ...
    {
        num: 26, icon: '📈', title: 'Scaling & Performance', level: 'Advanced',
    ...
    {
        num: 27, icon: '🔄', title: 'Concurrency & Parallelism', level: 'Advanced',
    ...
    {
        num: 28, icon: '🗂️', title: 'Object Storage & Large Files', level: 'Advanced',
    ...
    {
        num: 29, icon: '⚡', title: 'Realtime Backend Systems', level: 'Advanced',
    ...
    {
        num: 30, icon: '🧪', title: 'Testing & Code Quality', level: 'Core',
    ...
    {
        num: 31, icon: '📋', title: '12-Factor App', level: 'Advanced',
    ...
    {
        num: 32, icon: '📄', title: 'OpenAPI Standard', level: 'Core',
    ...
    {
        num: 33, icon: '🪝', title: 'Webhooks', level: 'Advanced',
    ...
    {
        num: 34, icon: '🚀', title: 'DevOps', level: 'Expert',
